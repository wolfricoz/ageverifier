...
class IdCheck(ABC) :
	...
	async def send_check(interaction: discord.Interaction, channel, message, age, dob, date_of_birth=None, years=None,
		...
		message = messages.get(message, {
			"user-message"    : f"There was an issue with the age and date of birth you provided. Please try again.",
			"channel-message" : f"Could not fetch idcheck message with key: {m_key}"
		})
