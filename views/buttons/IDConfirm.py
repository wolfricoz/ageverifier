...
class IDConfirm(discord.ui.View) :
	...
	async def confirm(self, interaction: discord.Interaction, button: discord.ui.Button) :
		...
		await self.member.send(
			f"Your ID verification entry has been updated with the date of birth: {self.dateofbirth} and your ID has been removed from our system. Thank you for using AgeVerifier!")
		return None

	@discord.ui.button(label="Cancel Verification", style=discord.ButtonStyle.red, custom_id="declineID")
	async def decline(self, interaction: discord.Interaction, button: discord.ui.Button) :
		"""This is a button"""
		await send_response(interaction, "ID verification process has been cancelled. Thank you for double checking.",
		                    ephemeral=True)
		return None
